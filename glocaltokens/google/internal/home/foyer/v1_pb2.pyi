...
class GetHomeGraphResponse(Message):
        ...
        class Device(Message):
            ...
            class DeviceInfo(Message):
                ...
                class ProjectInfo(Message):
                    ...
                    def ClearField(self, field_name: Literal[u"api_project_id",b"api_project_id",u"string2",b"string2"]) -> None: ...

                DEVICE_ID_FIELD_NUMBER: int
                PROJECT_INFO_FIELD_NUMBER: int
                device_id: Text = ...

                @property
                def project_info(self) -> GetHomeGraphResponse.Home.Device.DeviceInfo.ProjectInfo: ...

                def __init__(self,
                    *,
                    device_id : Text = ...,
                    project_info : Optional[GetHomeGraphResponse.Home.Device.DeviceInfo.ProjectInfo] = ...,
                    ) -> None: ...
                def HasField(self, field_name: Literal[u"project_info",b"project_info"]) -> bool: ...
                def ClearField(self, field_name: Literal[u"device_id",b"device_id",u"project_info",b"project_info"]) -> None: ...
        ...
        class Message13(Message):
            ...
            class Message1(Message):
                ...
                class DeviceInfo(Message):
                    ...
                    @property
                    def project_info(self) -> GetHomeGraphResponse.Home.Message13.Message1.DeviceInfo.ProjectInfo: ...

                    def __init__(self,
                        *,
                        device_id : Text = ...,
                        project_info : Optional[GetHomeGraphResponse.Home.Message13.Message1.DeviceInfo.ProjectInfo] = ...,
                        ) -> None: ...
                    def HasField(self, field_name: Literal[u"project_info",b"project_info"]) -> bool: ...
                    def ClearField(self, field_name: Literal[u"device_id",b"device_id",u"project_info",b"project_info"]) -> None: ...
    ...
    class Group(Message):
        ...
        class DeviceInfo(Message):
            ...
            @property
            def project_info(self) -> GetHomeGraphResponse.Group.DeviceInfo.ProjectInfo: ...

            def __init__(self,
                *,
                project_info : Optional[GetHomeGraphResponse.Group.DeviceInfo.ProjectInfo] = ...,
                ) -> None: ...
            def HasField(self, field_name: Literal[u"project_info",b"project_info"]) -> bool: ...
            def ClearField(self, field_name: Literal[u"project_info",b"project_info"]) -> None: ...
...
class GetAssistantDeviceSettingsRequest(Message):
    ...
    class DeviceInfo(Message):
        ...
        @property
        def project_info(self) -> GetAssistantDeviceSettingsRequest.DeviceInfo.ProjectInfo: ...

        def __init__(self,
            *,
            device_id : Text = ...,
            project_info : Optional[GetAssistantDeviceSettingsRequest.DeviceInfo.ProjectInfo] = ...,
            ) -> None: ...
        def HasField(self, field_name: Literal[u"project_info",b"project_info"]) -> bool: ...
        def ClearField(self, field_name: Literal[u"device_id",b"device_id",u"project_info",b"project_info"]) -> None: ...
...
class UpdateAssistantDeviceSettingsRequest(Message):
    ...
    class DeviceInfo(Message):
        ...
        @property
        def project_info(self) -> UpdateAssistantDeviceSettingsRequest.DeviceInfo.ProjectInfo: ...

        def __init__(self,
            *,
            device_id : Text = ...,
            project_info : Optional[UpdateAssistantDeviceSettingsRequest.DeviceInfo.ProjectInfo] = ...,
            ) -> None: ...
        def HasField(self, field_name: Literal[u"project_info",b"project_info"]) -> bool: ...
        def ClearField(self, field_name: Literal[u"device_id",b"device_id",u"project_info",b"project_info"]) -> None: ...
